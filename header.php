	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li class="nav-item">
					<a class="nav-link<?php echo $page == 'index' ? $active : ''; ?>" href="?page=index"><?php t("Home"); ?></a>
				</li>
				<li class="nav-item">
					<a class="nav-link<?php echo $page == 'dictionary' ? $active : ''; ?>" href="?page=dictionary"><?php t("Dictionary"); ?></a>
				</li>
				<li class="nav-item">
					<a class="nav-link<?php echo $page == 'tutorial' ? $active : ''; ?>" href="?page=tutorial"><?php t("Learn"); ?></a>
				</li>
				<li class="nav-item">
